...
test_that("get_ces removes the downloaded data file",{
  ...
  # User requests the 2019 CES online survey
  cesR::get_ces("ces2019_web")
  expect_true(!file.exists(file.path(system.file("extdata", package = "cesR"), "ces2019_web.dta")))

  # User requests the 2019 CES phone survey
  cesR::get_ces("ces2019_phone")
  expect_true(!file.exists(file.path(system.file("extdata", package = "cesR"), "ces2019_phone.tab")))

  # User requests the 2015 CES online survey
  cesR::get_ces("ces2015_web")
  expect_true(!file.exists(file.path(system.file("extdata", package = "cesR"), "ces2015_web.zip")))
  ...
  # User requests the 2015 CES combined survey
  cesR::get_ces("ces2015_combo")
  expect_true(!file.exists(file.path(system.file("extdata", package = "cesR"), "ces2015_combo.zip")))
  ...
  # User requests the 2004-2011 CES surveys
  cesR::get_ces("ces0411")
  expect_true(!file.exists(file.path(system.file("extdata", package = "cesR"), "ces0411.zip")))
