...
data_file <- here::here("inst/extdata/CES-E-1965.zip")

# unzip 'data_file' and place unzipped folder in 'instdir' file location.
unzip(data_file, exdir = here::here("inst/extdata/ces1965"))

# assign directory within the unzipped folder.
instdir_main <- here::here("inst/extdata/ces1965")
...
for(i in 1:length(files)){
  ces1965 <- haven::read_sav(file = files[i])
}
...
save(ces1965, file = "ces1965.RData")
