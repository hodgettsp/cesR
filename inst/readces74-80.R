...
data_file <- here::here("inst/extdata/CES-E-1974-1980.zip")

# unzip 'data_file' and place unzipped folder in 'instdir' file location.
unzip(data_file, exdir = here::here("inst/extdata/ces74-80"))

# assign directory within the unzipped folder.
instdir_main <- here::here("inst/extdata/ces74-80")
...
for(i in 1:length(files)){
  ces7480 <- haven::read_sav(file = files[i])
}
...
save(ces7480, file = "ces7480.RData")
