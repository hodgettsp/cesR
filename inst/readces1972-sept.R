...
data_file <- here::here("inst/extdata/CES-E-1972-sept.zip")

# unzip 'data_file' and place unzipped folder in 'instdir' file location.
unzip(data_file, exdir = here::here("inst/extdata/ces72-sept"))

# assign directory within the unzipped folder.
instdir_main <- here::here("inst/extdata/ces72-sept")
...
for(i in 1:length(files)){
  ces72_sep <- haven::read_sav(file = files[i])
}
...
save(ces72_sep, file = "ces72_sep.RData")
