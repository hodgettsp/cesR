...
# convert onlinesurvey values to factors and assign to object ces2019_web
ces2019_web <- onlinesurvey
# remove onlinesurvey object
rm(onlinesurvey)

# convert phonesurvey values to factors and assign to object ces2019_phone
ces2019_phone <- phonesurvey
# remove phonesurvey object
rm(phonesurvey)
...
save(ces2019_web, file = "ces2019_web.RData")
save(ces2019_phone,  file = "ces2019_phone.RData")
