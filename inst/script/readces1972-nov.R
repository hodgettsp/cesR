...
data_file <- here::here("inst/extdata/CES-E-1972-nov.zip")

# unzip 'data_file' and place unzipped folder in 'instdir' file location.
unzip(data_file, exdir = here::here("inst/extdata/ces72-nov"))

# assign directory within the unzipped folder.
instdir_main <- here::here("inst/extdata/ces72-nov")
...
for(i in 1:length(files)){
  ces72_nov <- haven::read_sav(file = files[i])
}
...
save(ces72_nov, file = "ces72_nov.RData")
