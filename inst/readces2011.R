# Script to read the CES SAV dataset & create RData files.
...
data_file <- here::here("inst/extdata/CES2011-final-1.zip")

# unzip 'data_file' and place unzipped folder in 'instdir' file location.
unzip(data_file, exdir = here::here("inst/extdata/ces2011"))

# assign directory within the unzipped folder.
instdir_main <- here::here("inst/extdata/ces2011")
...
for(i in 1:length(files)){
  ces2011 <- haven::read_sav(file = files[i])
}
...
save(ces2011, file = "ces2011.RData")
