...
data_file <- here::here("inst/extdata/CES-E-1968.zip")

# unzip 'data_file' and place unzipped folder in 'instdir' file location.
unzip(data_file, exdir = here::here("inst/extdata/ces1968"))

# assign directory within the unzipped folder.
instdir_main <- here::here("inst/extdata/ces1968")
...
for(i in 1:length(files)){
  ces1968 <- haven::read_sav(file = files[i])
}
...
save(ces1968, file = "ces1968.RData")
