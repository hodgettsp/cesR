...
data_file <- here::here("inst/extdata/CES-E-1974.zip")

# unzip 'data_file' and place unzipped folder in 'instdir' file location.
unzip(data_file, exdir = here::here("inst/extdata/ces1974"))

# assign directory within the unzipped folder.
instdir_main <- here::here("inst/extdata/ces1974")
...
for(i in 1:length(files)){
  ces1974 <- haven::read_sav(file = files[i])
}
...
save(ces1974, file = "ces1974.RData")
