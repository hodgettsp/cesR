...
#'
#' Both the online and phone survey datasets from the 2019 Canadian Election Survey (CES)
#'
...
#' For further details on the 2019 Canadian Election Survey, see \url{http://www.ces-eec.ca/}
